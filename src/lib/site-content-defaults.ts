...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  home: {
    ...
    servicesTeaser: {
      ...
      blurb:
        "From strategy consulting to cloud engineering — complete services for modern enterprises.",
    ...
    productsSection: {
      ...
      description:
        "Purpose-built software products engineered by Alpha Layers for finance, operations, and security teams.",
    ...
    projectsSection: {
      ...
      description:
        "Selected enterprise engagements across FinTech, cloud, and AI.",
  ...
  pages: {
    about: {
      ...
      ctaSubtext:
        "Tell us about your next initiative and we will craft a clear roadmap.",
    ...
    services: {
      ...
      description:
        "Strategy, engineering, cloud, security, and analytics under one roof.",
  ...
  collections: {
    ...
    faqs: [
      ...
      },
      {
        ...
        question:
          "Can Alpha Layers help migrate our infrastructure to the Cloud?",
        answer:
      ...
      },
      {
        ...
        question:
          "How do you structure project pricing and retainer contracts?",
        answer:
      ...
      },
      {
        ...
        category: "Custom Software",
        question:
          "Can you integrate modern AI models and automated workflows into our existing apps?",
        answer:
  ...
  modals: {
    quote: {
      ...
      subtitle:
        "Share a few details and our team will follow up with a tailored proposal.",
      serviceOptions: [
